...
export class PotManager {
  ...
  /**
   * Creates a new instance of PotManager, which is used to manage pots and
   * store outcomes for the duration of a game.
   *
   * @param  {Bot} {bot         The bot API
   * @param  {type} players     The players participating in the game
   * @param  {type} minimumBet} The minimum bet in the game
   */
  constructor({bot, players, minimumBet}) {
    this.bot = bot;
  ...
  handleOutcome(pot) {
    ...
    throw new Error('Replace with bot API'); //this.channel.send(message);
  }
